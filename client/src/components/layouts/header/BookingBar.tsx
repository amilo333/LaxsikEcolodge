import { Button, DatePicker, Select, Textfield } from '@/components/core';
  ...
  return (
    <div className='absolute top-[160%] left-1/2 z-10 w-full -translate-x-1/2 -translate-y-1/2 bg-white px-[56px] py-[24px] shadow-lg'>
      <div className='flex items-center gap-[10px]'>
        ...
        <Button className='h-[52px] w-[185px]!'>FIND NOW</Button>
        ...
        <div className='absolute top-[-6px] right-[142px] flex flex-col items-center'>
          ...
          <Button className='h-[24px] w-[90px]! bg-white text-[14px]! text-black!'>
            HIDE
          </Button>
        </div>
      </div>
